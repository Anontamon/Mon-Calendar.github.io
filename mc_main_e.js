...
function UIContent(u) {
	...
	for(i=0;i<eml;i++){
	   ...
	   <p class='MCTdP"+u.Size+"' style='font-family: "+cFont+";'>";
		...
		if ((i>=r)&&(js<=je)) { 
			...
			str+="<a href='Mon Calendar 1500 years.html"+M.my;
	...
	if (u.Size==1) {
		if (u.y<u.LT || u.y>u.UT) str+="<p class='MCFootIM' \
			...
			href='Mon Calendar 1500 years.html' class='MCThA11' \
...
function tFNote(fn,jd,M,hdt,rf) {
	...
	if (hdt.h && (hdt.hs[0]=="Myanmar New Year Day")) {
		...
		fn.s+="<br/>["+fn.n.toString()+"] အတာတက်ချိန်\
			...
			+" ဖြစ်သည်။ <a \
href='Mon Calendar 1500 years.html'\
	...
	" <a href='Mon Calendar ~1500 years .html"+hs.my+"'  class='MCThA11'>more &gt; &gt; </a>";
...
function tHead(cFont,u,MS,ME) {
	...
	<p class='MCThP' style='font-family: "+cFont+";'>";//table header
		if (u.Size==1) { //English year and Sasana year is not for small size
			str+="<a  class='MCThA11' href='Mon Calendar 1500 years.html'>"
		...
		if (ME.my>=2) { //if Myanmar year after 2 ME
			str+="<a  class='MCThA1"+u.Size+"' href='Mon Calendar 1500 years.html'>"+
				T("Myanmar Year")+" ";
			if (MS.my>=2) {
				str+=n2s(MS.my);
				if (MS.my!=ME.my) str+=" - ";
			...
			str+=" "+T('Ku')+T(',')+" </a>";
			if (MS.my>=2) {
				str+="<a  class='MCThA2"+u.Size+"' href='Mon Calendar 1500 years.html'>";
				if(MS.myt && MS.mm==4) str+=T('Second');
				str+=T(mma[MS.mm])+" </a>";
				if (MS.mm!=ME.mm) str+=" - ";
			}
			if (MS.mm!=ME.mm) {
				str+="<a  class='MCThA3"+u.Size+"' href='Mon Calendar 1500 years.html'>";
	...
	<p class='MCTdP"+u.Size+"' style='font-family: "+cFont+";'>";
		if (u.Size==1) {
			str+="<a class='MCAnchor' href=\
				 'Mon Calendar 1500 years.html'>M-&gt;E Calendar</a> ";
			str+="<a  class='MCAnchor'  style='float: right;' href=\
				 'Mon Calendar 1500 years.html'>About</a>";
		}
		else {
			str+="<span>*</span>\
...
function mMDStr(M,A,E,u_Astro,hde,hdm,hdt,hdo,jd) {
	var hls="Mon Calendar 1500 years.html";
	var str="",tstr="",hd;
...
function m2str(my,myt,mm,mmt,mp,d,wd){
	var hmma=["ပဒ္ဂိုန်","စဲ","ပသာ်","ဇှ်ေ","ဒ္ဂိုန်","ခ္ဍဲသဳ","ဘတ်",
		 "ဝှ်","က္ထိုန်","မြေက္ကသဵု","ပုဟ်","မာ်","ဖဝ်ရဂိုန်"];
	var hmpa=["မံက်","ပေၚ်","စွေက်","အိုတ်"];
	var hwda=['သ္ၚိသဝ်','အဒိုတ်','စန်','အၚာ','ဗုဒ္ဓဝါ','ဗြဴဗတိ','သိုက်']; 
	var str="သက္ကရာဇ်ဍုၚ် "+n2ms(my)+" သၞာံ၊ "; if(mmt) str+="နှောင်း";
